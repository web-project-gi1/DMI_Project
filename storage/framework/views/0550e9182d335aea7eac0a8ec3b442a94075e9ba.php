...
<div class="container">
	<form method="POST" action="<?php echo e(route('AffectProfRes')); ?>">
		<?php echo e(csrf_field()); ?>

		<?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<div class="form-groupe">
			<label>- <?php echo e($module->name); ?></label>
...
<?php echo $__env->make('home_Chef_fil', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\echch\OneDrive\Bureau\working\DMIProject\resources\views/manage/AffectProfRes.blade.php ENDPATH**/ ?>